...
class ResetPasswords
{
    ...
    public function __construct()
    {
        ...
        $mail->SMTPAuth = true;
        $mail->Port = 2525;
        $mail->Username = '326eda74074555';
        $mail->Password = 'f302368620e10f';
    }
    ...
    public function sendEmail()
    {
        ...
        $url = 'http://localhost:82/paroly/create-new-password.php?selector=' . $selector . '&validator=' . bin2hex($token);
