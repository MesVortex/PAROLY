...
<body>
    ...
    <section id="sidebar">
        ...
        <ul class="side-menu top">
            ...
            <li>
                <a href="#">
                    <i class='bx'><svg xmlns="http://www.w3.org/2000/svg" fill="#000000" width="25px" height="25px" viewBox="0 0 24 24">
