...
The way that things have been, oh-ooh ..."></textarea>
  ...
  <div class="flex items-start justify-between mb-5">
    ...
    <div class="flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-200 bg-[#121212] rounded-e-xl rounded-es-xl">
      ...
      <p class="text-sm font-normal py-2.5 text-gray-900 dark:text-white"><?php echo substr($l->text, 0, 100) ;?>... <button data-modal-target="authentication-modal<?php echo $l->id ;?>" data-modal-toggle="authentication-modal<?php echo $l->id ;?>" type="button" class=" font-medium text-green-500 italic">Read More</button></p>
      <!-- Read more Pop-Up -->
      <div id="authentication-modal<?php echo $l->id ;?>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto flex overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
              <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
              ...
              <button type="button" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="authentication-modal<?php echo $l->id ;?>">
                <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                </svg>
                <span class="sr-only">Close modal</span>
            ...
            <div class="p-4 md:p-5">
              <div class="space-y-4">
                <p id="songLyrics" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"><?php echo $l->text ;?></p>
              </div>
            </div>
          </div>
        </div>
